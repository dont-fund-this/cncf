...
var bootDef = BootDef(
    cmdline: "console=hvc0 root=/dev/vda rw PAT_DEVICE=apple-tablet-alpi",
    fbW: 2048,
    fbH: 1536,
    ram: 64
)
...
func prepareMounts() -> Bool {
    ...
    let guest = root + "/ocis/riscv64/apple/tablet/" + target()
    do {
    ...
    let base = "ocis/riscv64/apple/tablet/" + target()
